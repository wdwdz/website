...
```
## 9 Below are answers to specific questions
...
# BELOW ARE ANSWERS FOR EACH QUESTION: 
...
5.	Who do they spend time with in nature (at home and at work and for both pre and post covid) and how did it change – within and across subjects?

```{r}

```
6.	What do they do outdoors (activities) - (at home and at work and for both pre and post covid) and how did it change – within and across subjects?
```{r}

```
7.	Why do they spend time outdoors in nature, and how did this change during covid (Q4.2)
