...
#gender
mapply(function(x, y) chisq.test(x, y)$p.value, df.chi[, -5], MoreArgs=list(df.chi[,5]))
#time week
mapply(function(x, y) chisq.test(x, y)$p.value, df.chi[, -11], MoreArgs=list(df.chi[,11]))
#time hour
mapply(function(x, y) chisq.test(x, y)$p.value, df.chi[, -12], MoreArgs=list(df.chi[,12]))
