...
c. time outdoors correlation with: [TABLE]
i.	gender
...
a.	Correlation between WHY and time outdoors
b.	How do reasons for spending time outdoors intersect with:
...
e.	By neighborhood type are their changes in the number and type of places used pre to post covid, and within and across subjects
```{r}
...
a.	What does this intersect with – attitudes?
